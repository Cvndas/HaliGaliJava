...
| Sıla |      providePlayerName(), generateCpuNames(), PlayEndScreen(), PrintStatistics()  , https://github.com/Cvndas/HaliGaliJava/blob/main/src/main/java/Main.java#L106C2-L138C3 https://github.com/Cvndas/HaliGaliJava/blob/main/src/main/java/Main.java#L272C2-L305C3                                                                                                                                                                                                                         |             testProvidePlayerName_ValidName()                   |      testProvidePlayerName_EmptyThenValid(), testGenerateCpuNames_CorrectCountAndUniqueNames()                                                                                        |
